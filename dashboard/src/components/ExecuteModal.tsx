      ...
      <div className="bg-neutral-900/95 backdrop-blur-xl border border-neutral-700/30 rounded-2xl max-w-lg w-full shadow-2xl animate-slide-up">
        ...
        <div className="px-6 py-5 space-y-5">
          <div>
            ...
            <p className="text-sm text-neutral-200 font-mono bg-neutral-800/40 border border-neutral-800/50 rounded-lg px-3 py-2.5">
              {rendered}
            </p>
          </div>
          ...
          {status === 'idle' && (
            <div className="flex items-center gap-2 px-3 py-2 bg-neutral-800/30 border border-neutral-800/40 rounded-lg">
              ...
              <p className="text-xs text-neutral-500">
                Estimated fee: <span className="text-neutral-400 font-mono">~0.000005 SOL</span>
                <span className="text-neutral-600 ml-1">(base fee for 1 signature)</span>
              </p>
            </div>
          )}
