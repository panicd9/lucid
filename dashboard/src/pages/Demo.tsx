...
const steps: Step[] = [
  {
    ...
    visual: (
      <div className="w-full space-y-3">
        <div className="bg-slate-900/60 rounded-lg px-4 py-3 border border-slate-700/30">
          <div className="flex items-center gap-2 mb-2">
            <div className="w-2 h-2 rounded-full bg-violet-400" />
            <span className="text-xs font-heading text-violet-300 tracking-wide">Drift Governance</span>
          </div>
          <p className="text-sm text-slate-300 font-mono">add market 5 with oracle 9abc...def</p>
        </div>
        <div className="flex items-center gap-2 px-4">
          ...
          <span className="text-xs text-slate-500">Legitimate proposal created by DAO council</span>
        </div>
      </div>
    ),
  },
    ...
    visual: (
      <div className="w-full space-y-3">
        <div className="bg-red-500/5 rounded-lg px-4 py-3 border border-red-500/15">
          ...
          <p className="text-sm text-slate-500 font-mono line-through">add market 5 with oracle 9abc...def</p>
        ...
        <div className="flex items-center gap-2 px-4">
          ...
          <span className="text-xs text-slate-500">Attacker modifies CPI data before signers see it</span>
        </div>
      </div>
    ),
  },
  {
    ...
    visual: (
      <div className="w-full space-y-3">
        <div className="bg-slate-800/60 rounded-lg px-4 py-3 border border-slate-700/30">
          <div className="flex items-center gap-2 mb-2">
            <span className="text-[10px] font-semibold text-slate-500 uppercase tracking-wider">Ledger Display</span>
          </div>
          <div className="font-mono text-xs text-slate-500 leading-relaxed break-all">
        ...
        <div className="flex items-center gap-2 px-4">
          ...
          <span className="text-xs text-slate-500">Signer has no way to verify what they are approving</span>
        </div>
      </div>
    ),
  },
  {
    ...
    visual: (
      <div className="w-full space-y-3">
        <div className="bg-slate-900/80 rounded-lg px-4 py-3 border-gradient">
          <div className="flex items-center gap-2 mb-2">
            <span className="text-[10px] font-semibold text-amber-400/70 uppercase tracking-wider">Ledger Display</span>
          </div>
          <div className="font-mono text-sm text-amber-300/90 leading-relaxed">
            <p>expires 2026-04-10 12:00:00:</p>
            <p>approve add market 5 with oracle 9abc...def</p>
            <p className="text-slate-500">| wallet: drift-governance proposal: 42</p>
          </div>
        </div>
        <div className="flex items-center gap-2 px-4">
          <div className="w-5 h-5 rounded-full bg-emerald-500/20 border border-emerald-500/30 flex items-center justify-center">
          ...
          <span className="text-xs text-slate-500">Signer reads exactly what they approve — in plain text</span>
        </div>
      </div>
    ),
  },
    ...
    visual: (
      <div className="w-full space-y-3">
        ...
        <div className="flex items-center gap-2 px-4">
          ...
          <span className="text-xs text-slate-500">Ed25519 signature verified on-chain — the program reconstructs the message from state</span>
        </div>
      </div>
    ),
  },
  ...
  return (
    <div className="flex flex-col items-center pt-12 pb-16">
      ...
      <div className="text-center mb-10">
        <h1 className="text-2xl sm:text-3xl font-heading font-bold text-slate-100 tracking-wide mb-3">
          See Lucid in Action
        </h1>
        ...
        <div className="bg-slate-900/60 border border-slate-800/60 rounded-2xl overflow-hidden shadow-2xl">
          ...
          <div className="px-5 sm:px-8 pt-8 pb-4">
            <div className="flex items-center gap-3 mb-4">
              <span className="shrink-0 w-8 h-8 rounded-lg bg-amber-500/10 border border-amber-500/20 flex items-center justify-center text-sm font-heading font-bold text-amber-400">
                {currentStep + 1}
              </span>
              <h2 className="text-lg font-heading font-semibold text-slate-100 tracking-wide">
          ...
          {/* Visual mockup */}
          <div key={currentStep} className="mx-5 sm:mx-8 mb-8 bg-slate-800/30 border border-slate-800/50 rounded-xl p-6 min-h-[180px] flex items-center justify-center animate-step-in">
          ...
          <div className="flex items-center justify-between px-5 sm:px-8 py-5 border-t border-slate-800/50">
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                className="px-4 py-2 text-sm text-slate-400 hover:text-slate-200 disabled:opacity-30 disabled:cursor-not-allowed transition-colors cursor-pointer rounded-lg hover:bg-slate-800/50"
              >
                Back
              </button>
