...
export default function Home() {
  ...
  return (
    <div className="flex flex-col items-center pt-16 pb-12">
      ...
      <h1 className="text-4xl font-bold text-slate-100 mb-2">Lucid</h1>
        ...
        <div className="space-y-2">
          {DEMO_WALLETS.map((w) => (
            <button
              ...
              className="w-full text-left px-4 py-3 bg-slate-800/50 border border-slate-700 rounded-lg hover:border-slate-600 hover:bg-slate-800 transition-colors group"
            >
